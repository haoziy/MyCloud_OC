...
@protocol WLRangeSliderDelegate <NSObject>
...
@property (nonatomic,assign) id<WLRangeSliderDelegate>delegate;
//testing
//@property (nonatomic,copy) void (^ValueBlock)(float left,float right);
